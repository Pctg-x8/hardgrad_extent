...
impl ApplicationBufferData
{
	...
	pub fn offset_ppvbuf(&self) -> usize { self.alloc_bp.offset(0) }
	pub fn offset_vbuf(&self) -> usize { self.alloc_bp.offset(1) }
	pub fn offset_ibuf(&self) -> usize { self.alloc_bp.offset(2) }
	pub fn offset_instance(&self) -> usize { self.alloc_bp.offset(3) }
	pub fn offset_uniform(&self) -> usize { self.alloc_bp.offset(4) }
