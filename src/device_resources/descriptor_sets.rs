...
{
	#[allow(dead_code)] pool: vk::DescriptorPool<'d>, pub set_layout_ub1: vk::DescriptorSetLayout<'d>,
...
impl <'d> DescriptorSets<'d>
{
	...
	{
		let pool = device.create_descriptor_pool(2, &[VkDescriptorPoolSize(VkDescriptorType::UniformBuffer, 2)]).unwrap();
		let layout_bindings = [
